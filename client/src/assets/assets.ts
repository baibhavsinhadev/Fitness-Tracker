...
export const quickActivities = [
    { name: "Walking", icon: "walking", rate: 5 },
    { name: "Running", icon: "running", rate: 11 },
    { name: "Cycling", icon: "cycling", rate: 8 },
    { name: "Swimming", icon: "swimming", rate: 10 },
    { name: "Yoga", icon: "yoga", rate: 4 },
    { name: "Weight Training", icon: "weights", rate: 6 },
] as const;
...
export const activityColors = {
    walking: "bg-blue-100 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400",
    running: "bg-red-100 text-red-600 dark:bg-red-900/20 dark:text-red-400",
    cycling: "bg-emerald-100 text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400",
    swimming: "bg-cyan-100 text-cyan-600 dark:bg-cyan-900/20 dark:text-cyan-400",
    yoga: "bg-purple-100 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400",
    weights: "bg-orange-100 text-orange-600 dark:bg-orange-900/20 dark:text-orange-400",
} as const;
